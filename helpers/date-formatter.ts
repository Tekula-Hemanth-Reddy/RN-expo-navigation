...
export function calculateDateWithoutFormat(date: Date, days: number) {
    return moment(date).add(days, 'days');
}

export function calculateDateAndFormatIso(date: Date, days: number) {
    return moment(date, 'DD/MM/YYYY').add(days, 'days').format('YYYY-MM-DD');
}

export function calculateDateAndFormatIsoBySubtractingDays(date: Date, days: number) {
...
export function customFormat(date: Date, format: string) {
...
export function convertToDateTimeFormat(date: any) {
    const dateInISOFormat = moment(date).format('DD-MM-YY');
    const timeInISOFormat = moment(date).format('HH:mm:ss');
    return dateInISOFormat + '\n' + timeInISOFormat;
}

export function convertDateToTZFormat(date: any) {
    return moment.utc(date).format();
}

export function convertDateToStartOfDayWithTZFormat(date: any) {
    return moment.utc(date).startOf('day').format();
}

export function convertDateToEndOfDayWithTZFormat(date: any) {
